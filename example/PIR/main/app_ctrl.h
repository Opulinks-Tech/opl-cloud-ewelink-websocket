...
typedef enum blewifi_app_ctrl_msg_type
{
    ...
    APP_CTRL_MSG_PIR_STATECHANGE,
    APP_CTRL_MSG_PIR_DEBOUNCETIMEOUT,
#ifdef __IDR_EN__  //from build config
    APP_CTRL_MSG_IDR_CHANGE,
    APP_CTRL_MSG_IDR_TIMEOUT,
#endif

    APP_CTRL_MSG_DAILY_BATTERY_POST_TIMEOUT,
...
#define APP_CTRL_EVENT_BIT_BUTTON_PRESS    0x00008000U
...
#if(DAMAGE_EN == 1)
#define APP_CTRL_EVENT_BIT_DAMAGE_TRIGGER              0x00080000U
#endif
#define APP_CTRL_EVENT_BIT_PIR_DETECT                  0x00100000U  // PIR Status  true: block  , false:empty
#ifdef __IDR_EN__  //from build config
#define APP_CTRL_EVENT_BIT_IDR_DETECT                  0x00200000U  // IDR Status  true: light  , false:dark
#endif
#define APP_CTRL_EVENT_BIT_WIFI_AUTOCONN_LED           0x00400000U
...
typedef enum app_ctrl_led_state
{
    ...
    APP_CTRL_LED_PIR_ONLINE_ON_1,
    APP_CTRL_LED_PIR_ONLINE_OFF_1,
    APP_CTRL_LED_PIR_OFFLINE_ON_1,
    APP_CTRL_LED_PIR_OFFLINE_OFF_1,
    APP_CTRL_LED_PIR_OFFLINE_ON_2,
    APP_CTRL_LED_PIR_OFFLINE_OFF_2,
    APP_CTRL_LED_PIR_MP_ON_1,
    APP_CTRL_LED_PIR_MP_OFF_1,

#if(DAMAGE_EN == 1)
    APP_CTRL_LED_DAMAGE_ONLINE_ON_1,
    APP_CTRL_LED_DAMAGE_ONLINE_OFF_1,
    APP_CTRL_LED_DAMAGE_OFFLINE_ON_1,
    APP_CTRL_LED_DAMAGE_OFFLINE_OFF_1,
    APP_CTRL_LED_DAMAGE_OFFLINE_ON_2,
    APP_CTRL_LED_DAMAGE_OFFLINE_OFF_2,
#endif
...
typedef struct
{
    uint8_t ubaPIRStatus;     /* PIR Status */
#ifdef __IDR_EN__  //from build config
    uint8_t ubaIDRstatus;     /* IDR Status */
#endif
    uint8_t ubaType;           /* Type Status */
    time_t aTimeStamp;         /* Time */
} Sensor_Data_t;
